...
namespace Ljk.Dapper.App {
    public partial class Form_Main:Form {
        ...
        private void btn_PageClicked(object sender,EventArgs e) {
            int pageSize = MyUtil.ParseInt(tbx_PageSize.Text,10);
            int pageIndex = MyUtil.ParseInt(tbx_PageIndex.Text,1);
            ...
            MyResult<TSysConfiguration> result = null;
        ...
        private void btn_GetRow_Click(object sender,EventArgs e) {
            int pk_Int = MyUtil.ParseInt(dgv[0,dgv.CurrentCell.RowIndex].Value);

...
namespace Fisher.Core.DbLibrary {
   ...
   public class TFlowClean {
      ...
      [FisherField(Name="CleanUserID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]
      public virtual int? CleanUserID {
          get;
          set;
      }
      [FisherField(Name="ProcessID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]
      public virtual int? ProcessID {
          get;
          set;
      }
      [FisherField(Name="BatchNumberID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]

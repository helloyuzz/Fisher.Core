...
namespace CSSD.Web.API.Dapper.vo {
   ...
   public class TFlowApply {
      ...
      [LjkDapperField(Name="ApplyDate",SqlDbType=SqlDbType.DateTime,MaxLength=16)]
      ...
      [LjkDapperField(Name="RegisterUserID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]
      ...
      [LjkDapperField(Name="OpenPackageUserID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]

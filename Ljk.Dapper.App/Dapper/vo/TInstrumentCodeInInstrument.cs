...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TInstrumentCodeInInstrument",Remarks="")]
   public class TInstrumentCodeInInstrument {
      [LjkDapperField(Name="ID",SqlDbType=SqlDbType.Int,IsPrimaryKey = true,KEY_SEQ=1,AllowDBNull =false,MaxLength=4)]
      public virtual int? ID {
          get;
          set;
      }
      [LjkDapperField(Name="InstrumentCodeID",SqlDbType=SqlDbType.Int,MaxLength=4)]

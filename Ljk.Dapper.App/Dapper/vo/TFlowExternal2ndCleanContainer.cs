...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TFlowExternal2ndCleanContainer",Remarks="")]
   public class TFlowExternal2ndCleanContainer {
      ...
      [LjkDapperField(Name="CleanID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]
      public virtual int? CleanID {
          get;
          set;
      }
      [LjkDapperField(Name="ReviewState",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]

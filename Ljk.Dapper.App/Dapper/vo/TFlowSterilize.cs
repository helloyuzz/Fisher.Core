...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TFlowSterilize",Remarks="")]
   public class TFlowSterilize {
      ...
      [LjkDapperField(Name="SterilizeUserID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]
      ...
      [LjkDapperField(Name="SterilizeBatchID",SqlDbType=SqlDbType.Int,MaxLength=4,Remarks="科室ID")]

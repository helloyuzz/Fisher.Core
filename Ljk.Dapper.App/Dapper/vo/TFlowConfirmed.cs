...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TFlowConfirmed",Remarks="")]
   public class TFlowConfirmed {
      ...
      [LjkDapperField(Name="ConfirmedUserID",SqlDbType=SqlDbType.Int,MaxLength=4)]
      public virtual int? ConfirmedUserID {
          get;
          set;
      }
      [LjkDapperField(Name="ConfirmedOrgID",SqlDbType=SqlDbType.Int,MaxLength=4)]
      public virtual int? ConfirmedOrgID {
          get;
          set;
      }

...
namespace CSSD.Web.API.Dapper.vo {
   ...
   public class TInventoryOneTimeObjectCheckDetail {
      ...
      [LjkDapperField(Name="CheckID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]
      ...
      [LjkDapperField(Name="ActualQuantity",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]

...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TFlowCleanBatch",Remarks="")]
   public class TFlowCleanBatch {
      ...
      [LjkDapperField(Name="DeviceBatchNumber",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]

...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TFlowSterilizeBundle",Remarks="")]
   public class TFlowSterilizeBundle {
      [LjkDapperField(Name="ID",SqlDbType=SqlDbType.Int,IsPrimaryKey = true,KEY_SEQ=1,AllowDBNull =false,MaxLength=4,Remarks="序号")]
      public virtual int? ID {
          get;
          set;
      }
      [LjkDapperField(Name="SterilizeBatchID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4,Remarks="FlowID")]
      public virtual int? SterilizeBatchID {
          get;
          set;
      }
      [LjkDapperField(Name="BundleBarcode",SqlDbType=SqlDbType.NVarChar,MaxLength=400)]

...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TTraceRecycle",Remarks="")]
   public class TTraceRecycle {
      ...
      [LjkDapperField(Name="ActionTime",SqlDbType=SqlDbType.DateTime,MaxLength=16,Remarks="科室ID")]

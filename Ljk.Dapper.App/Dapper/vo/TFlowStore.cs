...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TFlowStore",Remarks="")]
   public class TFlowStore {
      ...
      [LjkDapperField(Name="StoreUserID",SqlDbType=SqlDbType.Int,MaxLength=4)]
      public virtual int? StoreUserID {
          get;
          set;
      }

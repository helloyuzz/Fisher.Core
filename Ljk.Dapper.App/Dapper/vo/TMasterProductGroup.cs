...
namespace CSSD.Web.API.Dapper.vo {
   ...
   public class TMasterProductGroup {
      [LjkDapperField(Name="ProductGroupID",SqlDbType=SqlDbType.Int,IsPrimaryKey = true,KEY_SEQ=1,AllowDBNull =false,MaxLength=4,Remarks="序号")]
      public virtual int? ProductGroupID {
          get;
          set;
      }
      [LjkDapperField(Name="ProductGroupName",SqlDbType=SqlDbType.NVarChar,MaxLength=100,Remarks="FlowID")]

...
namespace CSSD.Web.API.Dapper.vo {
   ...
   public class TMasterProductSimple {
      [LjkDapperField(Name="ProductSimpleID",SqlDbType=SqlDbType.Int,IsPrimaryKey = true,KEY_SEQ=1,AllowDBNull =false,MaxLength=4)]
      public virtual int? ProductSimpleID {
          get;
          set;
      }
      [LjkDapperField(Name="ProductSimpleName",SqlDbType=SqlDbType.NVarChar,AllowDBNull =false,MaxLength=100)]

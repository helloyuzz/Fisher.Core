...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TFlowPackReview",Remarks="")]
   public class TFlowPackReview {
      ...
      [LjkDapperField(Name="ReviewUserID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4)]
      ...
      [LjkDapperField(Name="UnqualifiedID",SqlDbType=SqlDbType.Int,MaxLength=4,Remarks="科室ID")]

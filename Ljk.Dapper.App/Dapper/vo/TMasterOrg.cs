...
namespace CSSD.Web.API.Dapper.vo {
   ...
   public class TMasterOrg {
      [LjkDapperField(Name="OrgID",SqlDbType=SqlDbType.Int,IsPrimaryKey = true,KEY_SEQ=1,AllowDBNull =false,MaxLength=4)]
      public virtual int? OrgID {
          get;
          set;
      }
      [LjkDapperField(Name="OrgName",SqlDbType=SqlDbType.NVarChar,AllowDBNull =false,MaxLength=100)]

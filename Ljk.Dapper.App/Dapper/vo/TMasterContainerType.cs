...
namespace CSSD.Web.API.Dapper.vo {
   ...
   public class TMasterContainerType {
      [LjkDapperField(Name="ContainerTypeID",SqlDbType=SqlDbType.Int,IsPrimaryKey = true,KEY_SEQ=1,AllowDBNull =false,MaxLength=4)]
      public virtual int? ContainerTypeID {
          get;
          set;
      }
      [LjkDapperField(Name="ContainerTypeName",SqlDbType=SqlDbType.NVarChar,AllowDBNull =false,MaxLength=100)]

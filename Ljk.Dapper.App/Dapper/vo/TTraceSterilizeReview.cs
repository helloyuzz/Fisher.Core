...
namespace CSSD.Web.API.Dapper.vo {
   [Serializable]
   [LjkDapperField(Name="TTraceSterilizeReview",Remarks="")]
   public class TTraceSterilizeReview {
      ...
      [LjkDapperField(Name="ComputedReviewResult",SqlDbType=SqlDbType.Int,MaxLength=4)]

...
namespace CSSD.Web.API.Dapper.vo {
   ...
   public class TFlowCleanAbnormal {
      [LjkDapperField(Name="CleanAbnormalID",SqlDbType=SqlDbType.Int,IsPrimaryKey = true,KEY_SEQ=1,AllowDBNull =false,MaxLength=4,Remarks="序号")]
      public virtual int? CleanAbnormalID {
          get;
          set;
      }
      [LjkDapperField(Name="InstrumentID",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4,Remarks="FlowID")]
      ...
      [LjkDapperField(Name="Quantity",SqlDbType=SqlDbType.Int,AllowDBNull =false,MaxLength=4,Remarks="科室ID")]

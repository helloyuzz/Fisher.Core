...
namespace Ljk.Dapper.App {
    public partial class Form_Main:Form {
        ...
        private void btn_PageClicked(object sender,EventArgs e) {
            int pageSize = LjkUtil.ParseInt(tbx_PageSize.Text,10);
            int pageIndex = LjkUtil.ParseInt(tbx_PageIndex.Text,1);
            ...
            LjkResult<TSysConfiguration> result = null;
        ...
        private void btn_GetRow_Click(object sender,EventArgs e) {
            int pk_Int = LjkUtil.ParseInt(dgv[0,dgv.CurrentCell.RowIndex].Value);
